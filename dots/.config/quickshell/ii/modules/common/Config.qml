        ...
        JsonAdapter {
            ...
            property JsonObject waffles: JsonObject {
                ...
                property JsonObject actionCenter: JsonObject {
                    property list<string> toggles: ["network", "bluetooth", "easyEffects", "powerProfile", "idleInhibitor", "nightLight", "darkMode", "antiFlashbang", "cloudflareWarp", "mic", "musicRecognition", "notifications", "onScreenKeyboard", "gameMode", "vrr", "screenSnip", "colorPicker", "videoEditor"]
                }
                property JsonObject calendar: JsonObject {
